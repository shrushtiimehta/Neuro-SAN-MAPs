...
Keep rides and shops on reachable paths so guests flow — ep1's rejected placements (steps 42,57,60 tile already contains path/ride) show wasted turns from poor tile choice. Leave open valid tiles for the 12-ride target and staff. Prune clutter (weak carousels) mid-game to keep the layout rating-positive.
