...
Front-load: reach 12 rides by step 35 (ep0 did, cum 5669) via carousels early then ferris_wheel and roller_coaster. VERIFY tile is empty/valid before every placement — ep1 lost steps 10,11,42,57,60 to rejected placements. Prune the weakest carousels around steps 46 and 62 (ep0 +933,+1692) once the modify engine is running, to lift park_rating. Do not keep placing rides past 12; shift to supporting the shop engine.
