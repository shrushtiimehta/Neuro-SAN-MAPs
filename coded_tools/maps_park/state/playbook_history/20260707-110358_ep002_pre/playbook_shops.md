...
You are the profit engine (trial t2_1). Stand up drink+food+specialty in turns 1-5, then MODIFY prices upward every single turn from ~step 39 to step 100 — ep0's drink/food modifies paid 600-1527/step and made the score. Never lapse into idle waits while a modify is positive; ep1's 41-wait tail (steps 60-100) is the mistake to avoid. Add a 7th shop mid-game (ep0 step48 +1131). Rotate across drink/food/specialty so no single shop's modify decays.
