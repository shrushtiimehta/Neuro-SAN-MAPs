...
Trial t2_2: turn research ON during the early build (ep0 set_research at step 42) and ESCALATE the tier above 'slow' as cash allows — ep0 never got past slow, ep1 left it 'none' all 100 steps. Aim for a tier above slow by step 50 and keep it on for 30+ steps. Toggle off only briefly if cash is tight for a critical placement, then resume.
