...
You are the primary reward engine. Place drink/food/specialty shops early (reach ~6-7 shops by turn 20), then MODIFY them continuously - re-tune drink/food/specialty nearly every turn from turn ~35 onward. Last ep's biggest per-step rewards were shop modifies (drink +1527, +1449; food +1250). Target >=25 shop-modify actions across the episode and keep this engine running all the way through turns 76-100 - do NOT go idle.
