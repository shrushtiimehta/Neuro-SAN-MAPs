...
Turn research ON early - by ~turn 42 at the latest - and KEEP IT RUNNING continuously to climb past 'slow' toward the fastest tier. Last ep never got past slow and toggled it on/off, and the step-79 re-toggle cost -453 then -431. Never toggle research off once on; only change it to escalate speed. Escalating research unlocks better rides/shops that can lift the late-game ceiling.
