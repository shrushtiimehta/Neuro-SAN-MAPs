...
Scale staff to support rising guest volume and rating. Hire mechanic early (~turn 12, last ep +307), then add janitors and specialists steadily to reach ~10 staff by turn 70. Janitors/mechanics hold rating in the low-to-mid 30s which sustains high modify rewards. Do not under-staff during the mid-game modify surge or rating (and rewards) will sag.
