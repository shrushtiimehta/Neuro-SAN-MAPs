...
Exercise t0_2: turn research ON by ~step 10 and keep it running the whole episode — ep0 never enabled it (research_speed 'none'). Prioritize unlocking higher-value ride/shop tiers so phases 4-7 can place premium items. Never toggle research off.
