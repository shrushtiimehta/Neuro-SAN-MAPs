...
Support continuous build-out: keep placement locations valid and adjacent-friendly so every turn's ride/shop placement succeeds without rejection. Avoid crowding that blocks new placements late-game; leave room to reach rides+shops>=15 by step 100.
