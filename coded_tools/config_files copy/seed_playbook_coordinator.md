...
- **Upgrade the shop set, avoid modifying it.** When research unlocks a higher tier, `remove` your low-tier shop and `place` the new tier on the tile it vacated next turn — two steps that buy a permanently better shop.
