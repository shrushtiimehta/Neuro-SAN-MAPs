...
After moving a low-tier ride off a valuable reachable tile, immediately refill that tile with a reachable red carousel when cash remains safely above $50000. (learned ep0)
